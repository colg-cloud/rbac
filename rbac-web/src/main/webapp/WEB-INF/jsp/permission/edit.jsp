        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form id="userForm" role="form">
              ...
              <button id="updateBtn" type="button" class="btn btn-success"><i class="glyphicon glyphicon-pencil"></i> 保存</button>
  ...
  <script>
    $(() => {
      ...
      $('#updateBtn').click(() => {
        ...
        $.ajax({
          type: 'post',
          url: '${applicationScope.APP_PATH}/permission/update',
          data: {name, url: $('#url').val(), id: '${permission.id}'},
          beforeSend: () => {
